...
export class localStorageArray {
     ...
     */
    unsynchronisedArray() {
        return this.#nonSynchronisedArray
    }
}
export let renWorks = {
    /**
     ...
     * @param {string|null} confirmBtnText 
     */
    beseech(msg, fn, defaultAnswer, confirmBtnText) {
     ...
     * @param {string|null} confirmBtnText 
     */
    beseechDropDown(options, msg, fn, confirmBtnText) {
        let dialogue = document.createElement("dialog");
        let dropdown = document.createElement("select");
        let text = this.cnewa("p", {}, msg);
        let btn = this.cnewa("button", {}, confirmBtnText || "Confirm");
        btn.onclick = () => {
    ...
    */
    ...
    // Deprecated since 2.1, use Result() instead
    /**
     *
     * @param {any} v
     * @param {Function} fn
